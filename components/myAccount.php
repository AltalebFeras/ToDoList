...
?>
<div>
    <h3 class="my-2 px-5 py-2 p-3 mb-2  text-dark ">Hello <?php
    ...
    <form id="formAccount" class="d-flex flex-column bd-highlight mb-3 form-control" method="post" action="./../src/treatment/updateUser.php">
